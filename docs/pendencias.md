...
| --- | --- | --- | --- |
| **P1** | Dumps reais de BCCM e airbag (e injeção) com KM e VIN conhecidos — 5 ou 6 pares | Mecânico | Levantar os perfis; sem eles o software não lê nada. Também decide a viabilidade do eixo Chave. |
...
| **P6** | Onde os dados moram no módulo (EEPROM / flash / ferramenta dedicada) | Define o equipamento de leitura/gravação. Confirma com módulo real. |
